...
## RGB LEDs
set_property -dict { PACKAGE_PIN L15    IOSTANDARD LVCMOS33 } [get_ports { blue_light }]; #IO_L22N_T3_AD7P_35 Sch=LED4_B
...
set_property -dict { PACKAGE_PIN M15    IOSTANDARD LVCMOS33 } [get_ports { red_light }]; #IO_L23N_T3_35 Sch=LED5_R
